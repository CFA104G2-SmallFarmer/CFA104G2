...
public class ProDiaryVO implements java.io.Serializable {
	...
	private Integer dir_upload_state;
	...
	public Integer getDir_upload_state() {
		return dir_upload_state;
	}
	public void setDir_upload_state(Integer dir_upload_state) {
		this.dir_upload_state = dir_upload_state;
	}
