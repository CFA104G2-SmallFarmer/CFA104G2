...
public class AnnouncementDAO implements AnnouncementDAO_Interface {
	...
	private static final String GET_ALL_STMT = "SELECT announce_id, announce_type, admin_id, edit_time, announce_title, announce_content FROM announcement ORDER BY announce_id DESC";
