...
//	ACTUAL_END_DATE 結束才有 PROJ_TOTAL_FUND df=0, PROJ_TOTAL_COUNT df=0, MEM_REPORT_COUNT 檢舉才有
	private static final String INSERT_STMT = "INSERT INTO PROJECT (F_MEM_ID,PROJ_NAME,PROJ_STATE,PROJ_MAIN_PIC,PROJ_ABSTRACT,PROJ_GOAL,START_DATE,EXPECTED_END_DATE,PROJ_TOTAL_FUND,PROJ_INTRO,PROJ_RISK,PROJ_TOTAL_COUNT,PROJ_VIDEO,PROJ_PAY)"
			+ "VALUES (?, ?, 0, ?, ?, ?,NOW(), ?, 0, ?, ?, 0, ?,  ?)";
	private static final String GET_ALL_STMT = "SELECT PROJ_ID,F_MEM_ID,PROJ_NAME,PROJ_STATE,PROJ_MAIN_PIC,PROJ_ABSTRACT,PROJ_GOAL,START_DATE,EXPECTED_END_DATE,ACTUAL_END_DATE,PROJ_TOTAL_FUND,PROJ_INTRO,PROJ_RISK,PROJ_TOTAL_COUNT,PROJ_VIDEO,MEM_REPORT_COUNT,PROJ_PAY FROM PROJECT ORDER BY PROJ_ID DESC";
...
//	不可改PROJ_ID, F_MEM_ID, START_DATE
	...
	private static final String GET_ALL_SAME_FMEM_STMT = // 列出某小農的所有專案
			"SELECT PROJ_ID,F_MEM_ID,PROJ_NAME,PROJ_STATE,PROJ_MAIN_PIC,PROJ_ABSTRACT,PROJ_GOAL,START_DATE,EXPECTED_END_DATE,ACTUAL_END_DATE,PROJ_TOTAL_FUND,PROJ_INTRO,PROJ_RISK,PROJ_TOTAL_COUNT,PROJ_VIDEO,MEM_REPORT_COUNT,PROJ_PAY FROM PROJECT WHERE F_MEM_ID=? ORDER BY PROJ_ID DESC";
