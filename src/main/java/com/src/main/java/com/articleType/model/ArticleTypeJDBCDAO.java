...
public class ArticleTypeJDBCDAO implements ArticleTypeDAO {
	...
	public static final String INSERT_STMT = "INSERT INTO ARTICLE_TYPE (article_type_ID, AC_TYPE_TEXT) VALUES ( ?, ?);";
	...
	@Override
	public void delete(int article_type_ID) {
		Connection con = null;
		PreparedStatement pstmt = null;
	...
	@Override
	public ArticleTypeVO findByPK(int article_type_ID) {
