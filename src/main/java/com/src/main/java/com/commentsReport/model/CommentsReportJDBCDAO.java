...
public class CommentsReportJDBCDAO implements CommentReportDAO  {
    ...
    public static final String UPDATE_STMT = "UPDATE COMMENTS_REPORT SET REPORT_STATE = ?, REPORT_NOTE = ?, REPORT_END_TIME = ? WHERE COMMENTS_REPORT_ID = ?;";
   // public static final String DELETE_STMT = "";
	...
	public void update(CommentsReportVO commentsReport) {
        ...
        try {
            ...
            pstmt.setDate(3,commentsReport.getReport_end_time());
            pstmt.setInt(4,commentsReport.getComments_report_ID());
...
//	@Override
//	public void delete(int cmt_report_ID) {}
		...
		CommentsReportVO commentsReport = null; // table-name
	        ...
	        try {
	            ...
	            while (rs.next()) {
	            	...
	            	commentsReport.setReport_time(rs.getDate("REPORT_TIME"));
	            	commentsReport.setReport_state(rs.getInt("REPORT_STATE"));
	            	commentsReport.setReport_note(rs.getString("REPORT_NOTE"));
	            	commentsReport.setReport_end_time(rs.getDate("REPORT_END_TIME"));
