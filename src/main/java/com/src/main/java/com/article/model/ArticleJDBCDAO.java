...
public class ArticleJDBCDAO implements ArticleDAO {
	...
	public static final String INSERT_STMT = "INSERT INTO ARTICLE (ARTICLE_TITLE, MEM_ID, ARTICLE_TYPE_ID, ARTICLE_TIME, ARTICLE_CONTENT, ARTICLE_IMG, ARTICLE_LIKE, COMMENTS_NUM, ARTICLE_CHANGE_TIME, ARTICLE_STATE,) VALUES (  ?, ?, ?, ?, ?, ?,'0','0','0','0');";
	public static final String UPDATE_STMT = "UPDATE ARTICLE SET ARTICLE_TITLE = ?, ARTICLE_CONTENT= ?, ARTICLE_IMG= ?, ARTICLE_STATE= ?, ARTICLE_CHANGE_TIME= ? WHERE ARTICLE_ID = ?;";
	...
	public void add(ArticleVO article) {
		...
		try {
			...
			pstmt.setDate(4, article.getArticle_time());
			pstmt.setString(5, article.getArticle_content());
			pstmt.setBytes(6, article.getArticle_img());
			pstmt.executeUpdate();
	...
	public void update(ArticleVO article) {
		...
		try {
			...
			pstmt.setString(1, article.getArticle_title());
			pstmt.setInt(2, article.getArticle_type_ID());
			pstmt.setString(3, article.getArticle_content());
			pstmt.setBytes(4, article.getArticle_img());
			pstmt.setInt(5, article.getArticle_like());
			pstmt.setInt(6, article.getComments_num());
			pstmt.setInt(7, article.getArticle_state());
			pstmt.setDate(8, article.getArticle_change_time());
...
@Override
public ArticleVO findByPK(int article_ID) {
	...
	try {
		...
		while (rs.next()) {
			...
			article.setArticle_change_time(rs.getDate("ARTICLE_CHANGE_TIME"));
