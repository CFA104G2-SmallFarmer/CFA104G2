...
public class ShopProductDBGifReader4 extends HttpServlet {
	Connection con;
...
//				"SELECT IMAGE FROM PICTURES WHERE PID = " + req.getParameter("PID"));
			"SELECT PROD_PIC FROM SHOP_PRODUCT WHERE PROD_ID = "+id);
...
//				res.sendError(HttpServletResponse.SC_NOT_FOUND);
				InputStream in = getServletContext().getResourceAsStream("/front-end/Product/images/farmforUploadPic.png");
