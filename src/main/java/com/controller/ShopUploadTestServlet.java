...
public class ShopUploadTestServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		for (Part part : parts) {
			...
			if (filename!= null && part.getContentType()!=null) {
				...
				String ContentType = part.getContentType();  //XXX若同一個檔名跟副檔名,後檔將會覆蓋前檔,不要使用
...
//		System.out.println(req.getRemoteAddr());  //抓哪個IP給我上傳圖
	}
