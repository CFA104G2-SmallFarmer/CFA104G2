...
public class AdministratorService {
	...
	public AdministratorVO updateAdminPwd(AdministratorVO administratorVO, String admin_pwd) {
	...
	public AdministratorVO getOneAdmin_byACC(String admin_acc) {
		return dao.findByACC(admin_acc);
	}
