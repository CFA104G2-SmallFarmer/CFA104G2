...
public class FarmTravelOrderJDBCDAO implements FarmTravelOrderDAO{
    ...
    public static final String INSERT_STMT = "INSERT INTO FARM_TRAVEL_ORDER ( MEM_ID, FARM_TRAVEL_ID, F_MEM_ID, ORDER_TIME, PEOPLE_NUM, ORDER_FEE, FARM_TRAVEL_START, FARM_TRAVEL_END, ORDER_STATE, ORDER_PAYMENT, ORDER_MEMO ) VALUES ( ?, ?, ?, NOW(), ?, ?, ?, ?, '0', ?, ? );";
    ...
    public void add(FarmTravelOrderVO farm_travel_order) {
        ...
        try {
            ...
            pstmt.setInt(8, farm_travel_order.getOrder_payment());
            pstmt.setString(9, farm_travel_order.getOrder_memo());
