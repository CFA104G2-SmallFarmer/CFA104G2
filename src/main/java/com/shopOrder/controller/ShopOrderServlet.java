...
//				}	
				...
				/***************************2.開始修改資料*****************************************/
				ShopOrderService shopOrderSvc = new ShopOrderService();
				shopOrderVO = shopOrderSvc.updateShopOrder(order_add,order_receiver,order_tel,order_memo,order_state,
						order_ship_date,order_finish_date,order_cancel_date,order_id);
...
//			日期藥用try catch才能收到null值，再設值回去
				...
				ShopOrderVO shopOrderVO2 = shopOrderSvc.updateShopOrder(order_add,order_receiver,order_tel,order_memo,order_state,
						order_ship_date,order_finish_date,order_cancel_date,order_id);
