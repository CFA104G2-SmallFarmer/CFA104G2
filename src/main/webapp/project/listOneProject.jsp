...
//ProjectServlet.java(Concroller), 存入req的projectVO物件
%>
...
<script src="./projectdetail_files/sdk.js.下載" async=""
	crossorigin="anonymous"></script>
<script src="./projectdetail_files/nr-1212.min.js.下載"></script>
<script async="" src="./projectdetail_files/fbevents.js.下載"></script>
<script id="facebook-jssdk" src="./projectdetail_files/sdk.js(1).下載"></script>
<script async="" src="./projectdetail_files/analytics.js.下載"></script>
<script async="" src="./projectdetail_files/9ve6cixxpl"></script>
...
<link href="./projectdetail_files/css" rel="stylesheet" type="text/css">
<link rel="stylesheet" media="all"
	href="./projectdetail_files/zeczec-e9e0ba9825d4b970fff398209948a791b4d18185e43b929ef4ffa0e7e5346248.css">
<script async="" type="text/javascript">
    (function(c,l,a,r,i,t,y){
        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};
        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;
        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
    })(window, document, "clarity", "script", "9ve6cixxpl");

    window.clarityDetectCount = 0

    function tagClarity() {
        if (typeof clarity === 'function') {

                clarity("set", "project_id", "11336");
        } else {
...
<path
			...
			<div class="w-70-l w-100 ph3-l">
				<div class="relative right-0 w-100 bottom-0 mw7">
					<div
						...
						style="background-image: url(&#39;./projectdetail_files/ori.png#39;)">
					</div>
				</div>
			</div>
					...
					<c:otherwise>
						<div class="w-30-l pv3 ph3 tc w-100">
							...
							<a class="bg-white button w-100 green hover-green focus grow"
								href="https://www.zeczec.com/users/sign_in?return_to=%2Fprojects%2Fparadisepet2022zeczecnewyear%2Forders%2Fback_project">
								贊助專案</a>
						</div>
					</c:otherwise>
				</c:choose>
								...
								<tr>
									<td>
										<div class="wysiwyg-text-align-center">
											...
											<p>
												<b><img alt=""
													src="./projectdetail_files/asset_422509_image_big.jpg"><span
			...
			<div class="w-30-l ph3-l ph0 flex-ns flex-wrap flex-column-l w-100">
				<div class="w-100-l w-50-ns ph3 ph0-l flex-none self-start">
					<a
						...
						src="./projectdetail_files/72345_banner.jpg" alt="72345 banner">
						<div class="black b f4">NT$476</div>
						<div class="f7 mv2">
							<span class="f7 white ph2 bg-red b dib"> 剩餘 232 份 </span><span
								class="black ph2 bg-near-white dib"> 已被贊助 <span class="b">68</span>
								/ 300 次
							</span>
						</div>
						<div class="black f6 mv-child-0 maxh5 maxh-none-ns overflow-auto">
							<p>
								"｜小農春聯套組，陪你喵言汪語賀新年！｜ <br>套組內含：小農門神、小農門聯、小農春聯與小農燙金紅包袋！ <br>新春將至，小農春聯套組送禮自用兩相宜！
							</p>
							<p>
								｜小農春聯套組｜ <br>市價620元，嘖嘖價 476（嘖嘖限量300組）
							</p>
							<p>
								＊如下單會於隔天出貨，假日除外。 <br>＊2022 年 1 月 24 日前最後寄出。 <br>＊如有特殊需求，請於「備註」欄備註。
								<br>＊將會開立電子發票並寄送至您的信箱。 <br>＊如需統編，請於備註欄填寫您的統一編號。 <br>＊本方案已內含台灣本島運費。
								<br>＊建議「全家超商取貨」，如需超取請確認門市後填寫。"
							</p>
						</div>
						<div class="mt3 gray tc ph2 f7 ba">預計於 2022 年一月實現</div> </a>
				</div>
				<div class="w-100-l w-50-ns ph3 ph0-l flex-none self-start">
					<a
						class="pa3 ba bw1 b--inherit round-s light-gray mb4 db border-rainbow "
						href="https://www.zeczec.com/users/sign_in?return_to=%2Fprojects%2Fparadisepet2022zeczecnewyear%2Forders%2Fback_project%3Fselected_reward%3D72350%23details"><img
						width="100%" class="mb2 round-s"
						src="./projectdetail_files/72350_banner.jpg" alt="72350 banner">
						<div class="black b f4">NT$200</div>
						<div class="f7 mv2">
							<span class="f7 white ph2 bg-red b dib"> 剩餘 193 份 </span><span
								class="black ph2 bg-near-white dib"> 已被贊助 <span class="b">7</span>
								/ 200 次
							</span>
						</div>
						<div class="black f6 mv-child-0 maxh5 maxh-none-ns overflow-auto">
							...
							<p>
								"｜小農門聯，好運汪汪來｜ <br>今年春節就用最可愛的小農門聯陪伴你， <br>喵言汪語，帶給你滿滿的快樂！
							</p>
							<p>
								｜小農門聯｜ <br>市價270元，嘖嘖價 200（嘖嘖限量200組）
							</p>
							<p>
								＊如下單會於隔天出貨，假日除外。 <br>＊2022 年 1 月 24 日前最後寄出。 <br>＊如有特殊需求，請於「備註」欄備註。
								<br>＊將會開立電子發票並寄送至您的信箱。 <br>＊如需統編，請於備註欄填寫您的統一編號。 <br>＊本方案已內含台灣本島運費。
				...
				<div class="w-100-l w-50-ns ph3 ph0-l flex-none self-start">
					<a
						class="pa3 ba bw1 b--inherit round-s light-gray mb4 db border-rainbow "
						href="https://www.zeczec.com/users/sign_in?return_to=%2Fprojects%2Fparadisepet2022zeczecnewyear%2Forders%2Fback_project%3Fselected_reward%3D72352%23details"><img
						width="100%" class="mb2 round-s"
						src="./projectdetail_files/72352_banner.jpg" alt="72352 banner">
						<div class="black b f4">NT$220</div>
						<div class="f7 mv2">
							<span class="f7 white ph2 bg-red b dib"> 剩餘 180 份 </span><span
								class="black ph2 bg-near-white dib"> 已被贊助 <span class="b">20</span>
								/ 200 次
							</span>
						</div>
						<div class="black f6 mv-child-0 maxh5 maxh-none-ns overflow-auto">
							...
							<p>
								"｜小農燙金紅包袋，日日有財好運來｜ <br>高品質燙金紅包袋，就是要給你滿滿的心意， <br>用最獨特的紅包袋，祝福你心中最獨特的人！
							</p>
							<p>
								｜小農燙金紅包袋｜ <br>市價300元，嘖嘖價 220（嘖嘖限量200組）
							</p>
							<p>
								＊如下單會於隔天出貨，假日除外。 <br>＊2022 年 1 月 24 日前最後寄出。 <br>＊如有特殊需求，請於「備註」欄備註。
								<br>＊將會開立電子發票並寄送至您的信箱。 <br>＊如需統編，請於備註欄填寫您的統一編號。 <br>＊本方案已內含台灣本島運費。
				...
				<div class="w-100-l w-50-ns ph3 ph0-l flex-none self-start">
					<a
						class="pa3 ba bw1 b--inherit round-s light-gray mb4 db border-rainbow "
						href="https://www.zeczec.com/users/sign_in?return_to=%2Fprojects%2Fparadisepet2022zeczecnewyear%2Forders%2Fback_project%3Fselected_reward%3D72344%23details"><img
						width="100%" class="mb2 round-s"
						src="./projectdetail_files/72344_banner.jpg" alt="72344 banner">
						<div class="black b f4">NT$140</div>
						<div class="f7 mv2">
							<span class="f7 white ph2 bg-red b dib"> 剩餘 189 份 </span><span
								class="black ph2 bg-near-white dib"> 已被贊助 <span class="b">11</span>
								/ 200 次
							</span>
						</div>
						<div class="black f6 mv-child-0 maxh5 maxh-none-ns overflow-auto">
							...
							<p>
								"｜小農門神，讓貓貓狗狗守護你！｜ <br>獨家繪製貓狗門神，貼在門上平安吉祥一整年！ <br>最棒的小農，守護最棒的你！
							</p>
							<p>
								｜小農門神｜ <br>市價200元，嘖嘖價 140（嘖嘖限量200組）
							</p>
							<p>
								＊如下單會於隔天出貨，假日除外。 <br>＊2022 年 1 月 24 日前最後寄出。 <br>＊如有特殊需求，請於「備註」欄備註。
								<br>＊將會開立電子發票並寄送至您的信箱。 <br>＊如需統編，請於備註欄填寫您的統一編號。 <br>＊本方案已內含台灣本島運費。
				...
				<div class="w-100-l w-50-ns ph3 ph0-l flex-none self-start">
					<a
						class="pa3 ba bw1 b--inherit round-s light-gray mb4 db border-rainbow "
						href="https://www.zeczec.com/users/sign_in?return_to=%2Fprojects%2Fparadisepet2022zeczecnewyear%2Forders%2Fback_project%3Fselected_reward%3D72351%23details"><img
						width="100%" class="mb2 round-s"
						src="./projectdetail_files/72351_banner.jpg" alt="72351 banner">
						<div class="black b f4">NT$180</div>
						<div class="f7 mv2">
							<span class="f7 white ph2 bg-red b dib"> 剩餘 195 份 </span><span
								class="black ph2 bg-near-white dib"> 已被贊助 <span class="b">5</span>
								/ 200 次
							</span>
						</div>
						<div class="black f6 mv-child-0 maxh5 maxh-none-ns overflow-auto">
							...
							<p>
								"｜小農春聯，五種心願一次滿足｜ <br>小小春聯，大大滿足， <br>想貼哪裡就貼哪裡，讓小農陪你可愛過好年！
							</p>
							<p>
								｜小農門聯｜ <br>市價250元，嘖嘖價 180（嘖嘖限量200組）
							</p>
							<p>
								＊如下單會於隔天出貨，假日除外。 <br>＊2022 年 1 月 24 日前最後寄出。 <br>＊如有特殊需求，請於「備註」欄備註。
								<br>＊將會開立電子發票並寄送至您的信箱。 <br>＊如需統編，請於備註欄填寫您的統一編號。 <br>＊本方案已內含台灣本島運費。
			...
			<div class="flex ph0-l ph3">
				...
				<div class="w-third-l w-100 mt-child-0 mb0-l mb4 relative">
					...
					<a
						...
						src="./projectdetail_files/透明LOGO小小農和手.png"> <!-- 旋轉logo在這裡logo-safari-fix -->
						<title>zeczec</title> <path
							src="./projectdetail_files/透明LOGO小小農和手.png"></path> </img> </a>
				</div>
			</div>
		</div>
	</footer>
	<div
		class="pa3 z-5 bt b--moon-gray w-100 relative bg-near-white fixed bottom-0 js-cookie-banner"
		hidden="">
		<div class="container pv4-ns">
			<div class="flex-ns flex-nowrap items-center">
				<div class="f6 mr3-ns">
					<p class="mt0">
						嘖嘖網站以及嘖嘖網站使用的第三方服務利用必要的瀏覽器 cookies
						技術達成部分網站必須功能。若有興趣了解更多相關資訊或反悔同意的條款，請詳閱我們的<a
							class="underline dark-gray" data-track="GDPR#ClickPrivacy"
							href="https://www.zeczec.com/docs/privacy">隱私權政策</a>及 <a
							class="underline dark-gray" data-track="GDPR#ClickCookies"
							href="https://www.zeczec.com/cookies">cookies 需求</a> 。
					</p>
					<p class="mb0-ns">點下此通知窗以外的任何連結或按鈕、捲動這個頁面、或以任何方式繼續使用嘖嘖網站，代表你同意了我們的隱私權政策及
						cookies 存取。</p>
				</div>
				<button class="button f6 bg-dark-green white js-accept-cookies bn"
					data-track="GDPR#ClickAccept" type="button">接受 &amp; 關閉</button>
			</div>
		</div>
	</div>
	<script
		src="./projectdetail_files/zeczec-75aefb6b17bb84ace5c7e76b106774304d1830945ab570527f3cb44045f686b1.js.下載"
  ...
  fbq('track', 'PageView');
	...
	<script defer=""
		src="./projectdetail_files/v652eace1692a40cfa3763df669d7439c1639079717194"
	...
	<h3>員工資料 - ListOneProject.jsp</h3>
	<h4>
		<a href="select_page.jsp"><img src="images/back1.gif" width="100"
	...
	<table>
		...
		<tr>
			<td><%=projectVO.getProj_id()%></td>
			<td><%=projectVO.getF_mem_id()%></td>
			<td><%=projectVO.getProj_name()%></td>
			<td><%=projectVO.getStart_date()%></td>
			<td><%=projectVO.getExcepted_end_date()%></td>
			<td><%=projectVO.getProj_goal()%></td>
			<td><%=projectVO.getProj_total_fund()%></td>
		</tr>
	</table>
