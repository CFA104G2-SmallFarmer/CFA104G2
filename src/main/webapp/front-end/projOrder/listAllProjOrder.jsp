...
<%
	...
	List<ProjOrderVO> list = projOrderSvc.getAll();
...
<%--     <c:set var="perk_id" scope="page" value="${projOrderVO.perk_id}"/> --%>
<%--     <c:out value="${perk_id}"/> --%>


<%--     <jsp:useBean id="projPerkSvc" class="com.projPerk.model.ProjPerkService" /> --%>

<%-- <jsp:useBean id="projPerkVO" class="com.projPerk.model.ProjPerkVO" /> --%>
<%-- 	<c:out value="${projPerkVO.proj_id}"/> --%>
<%-- 	<jsp:useBean id="projectSvc" class="com.project.model.ProjectService" /> --%>
<%-- 	<jsp:useBean id="projectVO" class="com.project.model.ProjectVO" /> --%>
...
<!-- //  Integer perk_id = 1;  -->
<!-- //  ProjPerkService projPerkSvc = new ProjPerkService();  -->
<!-- //  List<ProjPerkVO> list1 = projPerkSvc.getAll(perk_id); -->
