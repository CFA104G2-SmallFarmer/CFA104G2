          ...
          <div class="js-activatable relative dib" data-userid="2046860">
            <button aria-label="個人選單" class="js-activatable-trigger button-text" type="button">
              <div class="button button-s button-avatar round w2 h2 b--light-gray"><img class="w-100 h-100"
                  src="<%=request.getContextPath()%>/front-end/projOrder/addOrderByMem_css/fallback.jpg" alt="Fallback"></div>
		...
		<c:forEach var="message" items="${errorMsgs}">
           ...
           <%=projOrderVO.getOrder_pay()%> --%>
                ...
                <div class="absolute mv3 ml3">
                  <input disabled  class="js-payment-method" type="radio" value="1" ${(projOrderVO.order_pay==1)? "checked":""}
                ...
                <div class="absolute mv3 ml3">
                  <input disabled class="js-payment-method" type="radio" value="2" ${(projOrderVO.order_pay==2) ? "checked":""} name="order_pay"
...
<%--  <p> mem_id= <%=memVO.getMem_id()%></p> --%>
			     				...
			     				<input type="hidden" name="action" value="update_ByMem">	 			  
