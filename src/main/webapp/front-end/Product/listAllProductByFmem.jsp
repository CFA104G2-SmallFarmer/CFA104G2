            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        ...
                        <a href="addProductByFmem.jsp" class="breadcrumb-item text-dark" >Shop</a>
            ...
            <table class="table table-light table-border table-hover text-center mb-0">
             ...
             <c:forEach var="shopProductVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
                    <tr>
                       ...
                       <td>${shopProductVO.prod_type_id}</td>
                        <td>
                        
           <c:set var="pay_num" scope="request" value="${shopProductVO.prod_status}"/>
                           
                                  
                                ${prod__upload_arr[pay_num]}
