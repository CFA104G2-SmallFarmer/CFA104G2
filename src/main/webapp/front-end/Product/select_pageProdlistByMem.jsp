                ...
                <div class="bg-light p-30"><br>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade" id="tab-pane-2">
                            <button type="button" class="btn btn-success" >購買流程</button><br>
				
					<br>
					<div>
					<font>首次購物：歡迎加入！請於官網右上角點選「會員註冊」，註冊一個專屬於您的購物帳號<br>
                     ...
                     <br>
                     <br>
                      <button type="button" class="btn btn-success" >關於退貨</button><br>
<!-- 					<font>出貨說明</font> -->
					...
					<br><br>只要是非商品本身的瑕疵，恕無法為您辦理退換貨，下單前消費者們請務必考慮。</font>
                     ...
                     <button type="button" class="btn btn-success" >出貨說明</button><br>
<!-- 					<font>出貨說明</font> -->
