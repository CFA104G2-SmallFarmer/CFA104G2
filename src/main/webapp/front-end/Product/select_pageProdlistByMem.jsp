        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="bg-light p-30"><br>
                    ...
                    <div >
                        <div >
                            <button type="button" class="btn btn-success" style="font-size:20px;" >購買流程</button><br>
				
					<br>
					<div>
					<font style="font-size:20px;">首次購物：歡迎加入！請於官網右上角點選「會員註冊」，註冊一個專屬於您的購物帳號<br>
                     ...
                     <br>
                     <br>
                      <button type="button" class="btn btn-success" style="font-size:20px;" >關於退貨</button><br>
<!-- 					<font>出貨說明</font> -->
					...
					<br><br>只要是非商品本身的瑕疵，恕無法為您辦理退換貨，下單前消費者們請務必考慮。</font>
                     ...
                     <button type="button" class="btn btn-success" style="font-size:20px;">出貨說明</button><br>
<!-- 					<font>出貨說明</font> -->
				
					<br>
					<div>
					<font style="font-size:20px;">當您的信用卡資料核對無誤後，該筆交易便完成付款程序，貨到付款則直接進行配送。
