...
%>
<%
	ShopProductVO shopProdVO = (ShopProductVO) request.getAttribute("shopProdVO");
 ...
 <jsp:useBean id="shopProductSvc" scope="page" class="com.shopProduct.model.ShopProductService" />
  ...
  <!-- ---------------------------------------------------------------------------------------------------- --> 
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<%=request.getContextPath()%>/front-end/Product/ShopProductDBGifReader4?id=${shopProdVO.prod_id}" alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href=""><%=shopProdVO.getProd_name()%></a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5><a>$</a><%=shopProdVO.getProd_price()%><a>元/</a></h5>
                                     <h5><%=shopProdVO.getProd_unit()%></h5>
                                </div>
                            </div>
                        </div>
                    </div>
