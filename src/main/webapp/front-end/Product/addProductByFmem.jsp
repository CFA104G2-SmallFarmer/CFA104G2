       ...
       <form class="js-previewable-sum"
          ...
          <div class="flex mb5 f6 gutter3">
            <div class="w-30-ns w-20 fl ph3">
              <div class="cf">
                <img id="img1" class="w-80 mb3" src="<%=request.getContextPath()%>/front-end/Product/images/farmforUploadPic.png" alt="">
            ...
            <div class="w-70-l w-150 ph2">
              ...
              <div class="">  
                <label for="user_email" style="font-size:23px">小農會員編號:</label><br>
                  <input required="required" class="w-30 mb3" type="text" value="<%= (shopProductVO==null)? "70000" : shopProductVO.getF_mem_id()%>" name="f_mem_id" style="font-size:23px" /><br>
                <label for="user_name" style="font-size:23px"">商品名稱:</label><br>
                <input required="required" class="w-30 mb3" type="text" value="<%= (shopProductVO==null)? "草莓好吃" : shopProductVO.getProd_name()%>"  name="prod_name" style="font-size:23px" /><br>
           ...
           <label style="font-size:23px">商品類別:</label><br>
			...
			<c:forEach var="shopProductTypeVO" items="${productTypeSvc.all}">
                ...
                <select required="required" class="mb3 js-shipping-cost js-country-select js-update-sum-for-postage w-30"
                  autocomplete="country-name" name="prod_status" id="prod_status" style="font-size:23px">
                ...
                <div class="flex mt3">
                  <div class="flex-auto">
                   ...
                   <input required="required" class="mb3 w-50"  type="text" value="<%= (shopProductVO==null)? "888" : shopProductVO.getProd_price()%>" name="prod_price" style="font-size:23px" />
                  </div>
                  <div class="flex-auto">
                    <label  for="order_postcode" style="font-size:23px">商品單位:</label><br>
                    
                    <input required="required" class="mb3 w-50 js-postcode-field"  type="text" value="<%= (shopProductVO==null)? "台斤" : shopProductVO.getProd_unit()%>"  name="prod_unit" style="font-size:23px"/>
                  </div>
                  </div>
                </div>
                <div class="flex mt4">
                <div class="flex-auto">
                  <label  for="order_recipient" style="font-size:23px">商品數量:</label><br>
                   <input required="required" class="mb3 w-55" type="text" value="<%= (shopProductVO==null)? "666" : shopProductVO.getProd_qty()%>"  name="prod_qty" style="font-size:23px"/>
                </div>
                
                <div class="flex-auto">
                  <label  for="order_postcode" style="font-size:23px">商品上架日期:</label><br>
                  <input required="required" class="mb3 w-55 js-postcode-field" type="text" value="<%= (shopProductVO==null)? "2022-02-01" : shopProductVO.getProd_reg_date()%>" name="prod_reg_date" style="font-size:23px"/>
                </div>
              </div>
              ...
              <label for="order_note" style="font-size:23px">商品介紹:<span class="gray mb3" style="font-size:23px">特色說明</span></label><br><br>
                  <textarea wrap="hard" cols="30" placeholder="輸入內容"  class="w-100 height-100" type="text" value="" name="prod_intro" style="font-size:23px;x;resize:none;width:500px;height:300px;" /><%= (shopProductVO==null)?"": shopProductVO.getProd_intro()%></textarea>
                 
                <input type="hidden" name="action" value="insert">
				<button class="db js-submit-order button green mt3" style="font-size:23px" type="submit" value="送出新增"><i class="material-icons" style="font-size:18px">add</i> 送出新增 </button>
              </div>
            </div>
          </div>
          </form>
