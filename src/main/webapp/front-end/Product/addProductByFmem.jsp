		...
		function readFileContent1() {
            ...
            <div class="w-70-l w-150 ph2">
              ...
              <div class="">  
                <label for="user_email" style="font-size:23px">小農會員編號:</label><br>
                  <input required="required" class="w-30 mb3" type="text" value="<%= (shopProductVO==null)? "" : shopProductVO.getF_mem_id()%>" name="f_mem_id" style="font-size:23px" /><br>
           ...
           <label style="font-size:23px">商品類別:</label><br>
			...
			<c:forEach var="shopProductTypeVO" items="${productTypeSvc.all}">
              ...
              <label for="order_note" style="font-size:23px">商品介紹:<span class="gray mb3" style="font-size:23px">特色說明</span></label><br>
