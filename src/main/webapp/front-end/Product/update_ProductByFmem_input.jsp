			...
			fileReader1.readAsDataURL(file1);
					...
					<div class="w-70-l w-150 ph2">
						<div class="dn-ns db pt2" id="details"></div>
							...
							<label  for="order_note" style="font-size:23px">商品介紹:<span class="gray mb3" style="font-size:20px">特色說明</span></label><br><br>
							<textarea  placeholder="輸入內容"  class="w-100 height-100" type="text" value="" name="prod_intro" style="font-size:23px;x;resize:none;width:500px;height:300px;" /><%= (shopProductVO==null)?"": shopProductVO.getProd_intro()%></textarea>
