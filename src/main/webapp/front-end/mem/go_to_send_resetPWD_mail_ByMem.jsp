...
<!-- <iframe src="./header.jsp" width="100%"  scrolling="no" frameborder="0" style="z-index:999;position:relative" >
 ...
 <!--                        <div class="form-group"><span id="a4" style="line-height:32px;font-size:15px;"></span>
                        ...
                        <h2 style="color: #717d34;">重設密碼申請</h2>
                        <br>

                        <div class="form-group"><span>.<span id="a1" style="line-height:32px;font-size:15px;"></span></span>
                            <input id="username" class="form-control" placeholder="請輸入註冊信箱"  name="mem_acc" type="email" value="${memVO.mem_acc}">
                        </div>
...
<input type="hidden" name="action" value="send_resetPWD_mail_ByMem">
                        <button id="btn" class="btn btn-block fRed btn-submit"
                            style="margin-top: 20px; height: 40px;" type="submit">提交申請</button>
