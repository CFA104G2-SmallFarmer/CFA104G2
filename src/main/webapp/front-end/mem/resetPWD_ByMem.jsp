...
<!-- <iframe src="./header.jsp" width="100%"  scrolling="no" frameborder="0" style="z-index:999;position:relative" >
  你的瀏覽器不支援 iframe
    ...
    <div class="authBlock greyTitleBox" style="min-height: 80vh; ">
        <div class="container"
            ...
            <br>
          <h2 style="color: #717d34;">重設密碼</h2>  
                <br>
                <!-- <p style="color: #434217;font-size:20px">重設密碼</p> -->
 ...
 <!--                        <div class="form-group"><span id="a4" style="line-height:32px;font-size:15px;"></span>
                        ...
                        <div style="margin-bottom: 2px;"class="form-group"><span id="a1" style="line-height:32px;font-size:15px;"></span>
                            <input id="username" class="form-control" placeholder="信箱"  name="mem_acc" type="hidden" value="${memVO.mem_acc}">
                        </div>

                        <div style="margin-bottom: 2px;"class="form-group"><span id="a2" style="line-height:32px;font-size:15px;"></span>
                            <input id="password" class="form-control" placeholder="新密碼 : 請輸入8-16個字，英文數字皆要有" required="" name="mem_pwd" type="password"
                                value="">
                        </div>

                        <div style="margin-bottom: 2px;"class="form-group"><span>.<span id="a3" style="line-height:32px;font-size:15px;"></span></span>
                            <input id="check_password" class="form-control" placeholder="確認密碼" required="" name="password_confirmation"
                                type="password" value="">
                        </div>
<input type="hidden" name="action" value="reset_PWD_ByMem">
                        <button id="btn" class="btn btn-block fRed btn-submit"
                            style="margin-top: 20px; height: 40px;" type="submit">送出修改</button>
		...
		<c:forEach var="message" items="${errorMsgs}">
			<li style="color:red">${message}</li>
                ...
                <div class="login-block flex-display space-between">
                    ...
                    <a href="" class="btn fGhostred">登入</a>
                </div>
            </div>
        </div>
    </div>
