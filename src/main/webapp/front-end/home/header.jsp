...
<section class="header-wrapper" style="position: static; margin: auto;">
    ...
    <header id="header">
      ...
      <div class="logo"><a href="https://www.buydirectlyfromfarmers.tw/">
      ...
      <div class="menu">
        <nav class="menu-top">
          <ul>
            ...
            <li class="m-logo"><a href="https://www.buydirectlyfromfarmers.tw/">
            ...
            <li>
              <a href="http://127.0.0.1:5500/%E5%89%8D%E5%8F%B0%E9%A6%96%E9%A0%812.html#">
            ...
            <li>
			<!-- 連接私訊 -->
            <form id="myForm" action="<%=request.getContextPath() %>/front-end/privateMessage/privateMessage.do" method="POST">
			<input id="userName" name="mem_name"  type="hidden" value="${memVO.mem_name}" /> 
			</form>
              <a style="cursor: pointer;"><svg onclick="sendName();" class="svg-inline--fa fa-envelope fa-w-16" style="font-size: 30px;color: #aaba8b;" aria-hidden="true" data-fa-processed="" data-prefix="far" data-icon="envelope" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm0 48v40.805c-22.422 18.259-58.168 46.651-134.587 106.49-16.841 13.247-50.201 45.072-73.413 44.701-23.208.375-56.579-31.459-73.413-44.701C106.18 199.465 70.425 171.067 48 152.805V112h416zM48 400V214.398c22.914 18.251 55.409 43.862 104.938 82.646 21.857 17.205 60.134 55.186 103.062 54.955 42.717.231 80.509-37.199 103.053-54.947 49.528-38.783 82.032-64.401 104.947-82.653V400H48z"></path></svg>
              </a>
            </li>
          </ul>
        </nav>
        <div class="m-menu-top" style="">
          ...
          <div class="m-logo"><a href="http://127.0.0.1:5500/%E5%89%8D%E5%8F%B0%E9%A6%96%E9%A0%812.html#"><img src="<%=basePath%>/front-end/home/header_files/透明LOGO有字有框.png"></a>
          </div>
        </div>
