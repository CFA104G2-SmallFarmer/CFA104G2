...
<head>
    ...
    <link rel="shortcut icon" href="<%=request.getContextPath()%>/front-end/assets/images/favicon.ico"
          type="image/x-icon"/>
        ...
        <section class="block">
            <div class="row">
                <img
                        ...
                        height="590"  style="display:block; margin:auto;"/>
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="box">
                    <a href="<%=request.getContextPath()%>/front-end/Product/shop.jsp"
                       id="angus-cattle-mix-chen_4112">
                        <div class="pic">
                            <img style="width:219px; height:146px;"
                                 src="<%=request.getContextPath()%>/front-end/home/images/istockphoto-1213438840-612x612.jpg">
            ...
            <div class="row">
                ...
                <div class="box">
                    <a href="#" id="angus-cattle-mix-chen_4112">
                        <div class="pic">
                            <img style="width:219px; height:146px;"
                                 src="<%=request.getContextPath()%>/front-end/home/images/牛牛.jpg">
                ...
                <div class="box">
                    <a href="#" id="angus-cattle-mix-chen_4112">
                        <div class="pic">
                            <img style="width:219px; height:146px;"
                                 src="<%=request.getContextPath()%>/front-end/home/images/16166553118483882050.jpg">
                ...
                <div class="box">
                    <a href="#" id="angus-cattle-mix-chen_4112">
                        <div class="pic">
                            <img style="width:219px; height:146px;"
                                 src="<%=request.getContextPath()%>/front-end/home/images/D072014D-24AA-A638-AAAD-E455B73CCBAF.jpg">
                ...
                <div class="box">
                    <a href="#" id="angus-cattle-mix-chen_4112">
                        <div class="pic">
                            <img style="width:219px; height:146px;"
                                 src="<%=request.getContextPath()%>/front-end/home/images/ldkdjwuwqo21.jpg">

                        </div>
                        <h5><span>鳳梨園一日遊</span></h5>


                        <p style="overflow-wrap: break-word;">好吃又好玩下次，要再去。桶子雞大推。請問是否有人吃過呢?
                            可以在下方留言...</p>
                    </a>
                </div>
