...
<html lang="zh-tw" class="no-js fontawesome-i2svg-active fontawesome-i2svg-complete arwf-inactive"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/8frlty15ix"></script><script async="" src="./home_files/clarity.js"></script><script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/8frlty15ix"></script><script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/gtm.js"></script><script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/analytics.js"></script><script defer="" src="<%=request.getContextPath()%>/front-end/home/home_files/all.js"></script>
  ...
  <script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/clarity(1).js"></script>
  <script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/8frlty15ix(1)"></script>
  <script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/gtm(1).js"></script>
  <script async="" src="<%=request.getContextPath()%>/front-end/home/home_files/analytics(1).js"></script>
  <script type="text/javascript" src="<%=request.getContextPath()%>/front-end/home/home_files/1473064767308.JS"></script>
...
<%--         <%@ include file="header.jsp" %> --%>
    ...
    <div id="uiLockId" style="display:none;position: fixed;top: 0;left: 0;z-index: 5;opacity: 0.6;width:100%;height:200%;color:white;background-color:#666666;text-align:center">
      <div style="position:fixed; z-index:100; top:200px; left:50%">
        <img style="position: relative;left: -50%; " src="<%=request.getContextPath()%>/front-end/home/home_files/farmers-animation.gif" alt="Farmer running">
      </div>
    </div>
      ...
      <div class="container">
        ...
        <section class="block">
          ...
          <div class="row">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Miaoli_Strawberry_Lan_4365/" id="Miaoli_Strawberry_Lan_4365">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/FV-412-1pic-btn.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/FV-412-btn-png.png">

                  <img class="label-mask" src="<%=request.getContextPath()%>/front-end/home/home_files/preorder_mask.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/2b977bd352ffaa8c704fc51929deb2db.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>綜合紅草莓百寶盒</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Fig-shelterfarm_3522/" id="Fig-shelterfarm_3522">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/FV-360-pic-btn.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-Fig-shelterfarm-1.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/bf93105d8541c09b0b57977f66b44ced.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>蜂蜜甜 有機轉無花果</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/fig-tu_1246/" id="fig-tu_1246">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-fig-tu-2_1.png">


                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/7f00858ba7d61f24b59b6da8c4a920d9.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>心花朵朵開 有機無花果</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/candied_date_ma_2013/" id="candied_date_ma_2013">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/candied_date_ma-btn.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/candied-date-ma-png2.png">

                  <img class="label-mask" src="<%=request.getContextPath()%>/front-end/home/home_files/preorder_mask.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/a81a140b43a81f093414c02c3055d220.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>正能量 有機蜜棗</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/honey-tangerine-Lin_3431/" id="honey-tangerine-Lin_3431">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/btn-png_2.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-png_1.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/d0f08a79b82e5d1e75cf9c9d505dc8a4.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>幸運草生！ 爆漿茂谷柑</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/ling-jiao-sweet-potato-Shuilin-Kao_3482/" id="ling-jiao-sweet-potato-Shuilin-Kao_3482">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn_9.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-png_2.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/4d27dbb16170bd06da6e5a28bfe33193.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>謝謝米的有機菱角地瓜</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/sweet-potato_147/" id="sweet-potato_147">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn-sweet-potato2.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/FV-033-pic-btn-sweet-potato__2.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/0d27b385552a800d61e3a5313aa9200b.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>謝謝米的有機黃金地瓜</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Pingtung-Babycorn-Wu_4291/" id="Pingtung-Babycorn-Wu_4291">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn(1).jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-png_1(1).png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/b36499e0d50beae4b4f508b752f9156a.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>脆嫩清甜 有機紅鬚玉米筍</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/yam-Fangyuan-Wei_4361/" id="yam-Fangyuan-Wei_4361">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn_2.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-png.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/e91aa92cc536535c90488bb83837e4c2.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>Q彈細緻 人蔘山藥切塊</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Yunlin_alusu_wu_4386/" id="Yunlin_alusu_wu_4386">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/FV-415-pic-btn.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/FV-415-btn-png.png">

                  <img class="label-mask" src="<%=request.getContextPath()%>/front-end/home/home_files/limited_mask.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/e83b3f8e6c98dae04eda194202fba366.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>日本網紋瓜之王 阿露斯哈密瓜</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/gift-tankan-2018_2022/" id="gift-tankan-2018_2022">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn02.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn-gift-tankan-2018_1.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/4294df0c9e04d3c078c665bdf76f68e9.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>有機桶柑 精美禮盒</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Zucchini-Kale-Daxi-Lin_3511/" id="Zucchini-Kale-Daxi-Lin_3511">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn_11.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-png_1.pngFV-348-copy0">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/5696bfc8a3a55794f22d8f84a19cce92.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>蔬食好搭檔 櫛瓜+羽衣甘藍組</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/beef_tomato_tsai_2644/" id="beef_tomato_tsai_2644">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/有機牛番茄_btn-270x270-72.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/FV-279-有機牛番茄_btn.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/a95957dbd5aa85f0933192ce3d1a25be.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>皮薄豐滿 有機牛番茄</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/yunlin-strawberry-jhang_4336/" id="yunlin-strawberry-jhang_4336">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/FV-411-3-pic-btn.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/FV-411-btn-png_1.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/dea16386644f9b9ead7222954dcfd92e.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>香軟嫩！有機豐香草莓</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/honeycrisp-liu-special_4377/" id="honeycrisp-liu-special_4377">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/FV319_btn_1.jpgFV-319-copy0">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/FV319_btn-png_1.pngFV-319-copy0">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/bd0ae096a8ee2ffd976e4ca5a3ca4afc.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>大禹嶺 本土蜜蘋果(惠)（惜福版）</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/yellow-fruit_2374/" id="yellow-fruit_2374">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/btn-yellow-fruit-1.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/btn-yellow-fruit-2.png">

                  <div class="head">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/d3bec67aca83762ab1c603c7e51de416.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>高膠質 草生黃金果</span></h5>
        ...
        <section class="block">
          ...
          <div class="row">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/chrysanthemum_1466/" id="chrysanthemum_1466">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/btn-chrysanthemum-1.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/pic--btn-red-.png">
                  ...
                  <div class="head">
                    ...
                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/6c86943658d0d1cbd6d48b6123ae4395.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>本土安心 黃金杭菊(菊花茶)</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/red-dates_1186/" id="red-dates_1186">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/btn-red.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/pic--btn.png">
                  ...
                  <div class="head">
                    ...
                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/046d521dfff98dce079e96ead582fec7.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>無農藥栽培 本土紅棗乾</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/firewood-brown-sugar_340/" id="firewood-brown-sugar_340">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/btn-firewood-brown-sugar-001.jpg">

                  <img class="mask" src="<%=request.getContextPath()%>/front-end/home/home_files/RE-030-pic-btn-firewood-brown-sugar_.png">
                  ...
                  <div class="head">
                    ...
                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/5f27a6ec2dfa030b26d193e09bb9761e.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>古法熬製！手工柴燒黑糖</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/18ranch-chicken-broth_1208/" id="18ranch-chicken-broth_1208">
                <div class="pic">
                  <img src="<%=request.getContextPath()%>/front-end/home/home_files/pic-btn-18ranch-chicken-broth_1.jpg">

                  <img class="mask" src="./小農首頁3_files/pic-btn-18ranch-chicken-broth.png">
                  ...
                  <div class="head">
                    ...
                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/2e405d13f82afa0f8a196c0070ea4200.jpg">

                    <img src="<%=request.getContextPath()%>/front-end/home/home_files/head1.png">

                  </div>
                </div>
                <h5><span>友善飼養 精煉雞高湯</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/taro-rice-cake-huadon_4311/" id="taro-rice-cake-huadon_4311">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-taro-rice-cake-huadon-02.jpg">

                  <img class="mask" src="./小農首頁3_files/btn-taro-rice-cake-huadon-2.png">



                  <img class="label-mask" src="./小農首頁3_files/preorder_mask.png">
                ...
                <h5><span>芋頭好多！手工芋頭糕（葷、素）</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/turnip-cake_856/" id="turnip-cake_856">
                <div class="pic">
                  <img src="./小農首頁3_files/pic-btn--turnip-cake-1_1.jpg">

                  <img class="mask" src="./小農首頁3_files/pic-btn--turnip-cake-2.jpg">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/donate-Nanjichangfoodbank_3806/" id="donate-Nanjichangfoodbank_3806">
                <div class="pic">
                  <img src="./小農首頁3_files/未命名-1_2.jpg">

                  <img class="mask" src="./小農首頁3_files/btn-2.png">
                ...
                <h5><span>認購行動 ♥ 南機場食物銀行 弱勢家庭食物募集</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/blackpeanut-wang_2540/" id="blackpeanut-wang_2540">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-270x270-72.jpg">

                  <img class="mask" src="./小農首頁3_files/btn-blackpeanut-wang-2.png">
                ...
                <h5><span>全程無農藥 帶殼黑金剛花生(原味炒熟)</span></h5>
        ...
        <section class="block">
            ...
            <div id="block-slide1" class="swiper-container">
              <div class="swiper-wrapper">
                <div class="swiper-slide" style="opacity:1;max-width: 100%;">
                  ...
                  <a href="https://www.buydirectlyfromfarmers.tw/catalogue/clam_guo_955/">
          ...
          <div class="row">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/organic_dried_colored_tomatoes_hsu_2949/" id="organic_dried_colored_tomatoes_hsu_2949">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-organic_dried_colored_tomatoes_hsu-1.jpg">

                  <img class="mask" src="./小農首頁3_files/btn-organic_dried_colored_tomatoes_hsu-2.png">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Irwin-mango-chen_1716/" id="Irwin-mango-chen_1716">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-mango-chen.jpg">

                  <img class="mask" src="./小農首頁3_files/btn-mango-chen-2.png">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/pitaya_red_huang_2988/" id="pitaya_red_huang_2988">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-png_2(2).jpg">

                  <img class="mask" src="./小農首頁3_files/btn-png_4.png">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/surprise-mangobox-chang_3859/" id="surprise-mangobox-chang_3859">
                <div class="pic">
                  <img src="./小農首頁3_files/FV-384btn.jpg">

                  <img class="mask" src="./小農首頁3_files/btn-FV385-01.png">
                ...
                <h5><span>有野兔芒果園之 綜合離奇芒果箱</span></h5>
...
<iframe src="<%= request.getContextPath() %>/front-end/home/footer.jsp" width="100%" height="100%" style="display: block;"></iframe>
          ...
          <div class="btn btn-hover handdraw-btn" style="position: relative; width: 261px; height: 43px;">
            ...
            <a href="https://www.buydirectlyfromfarmers.tw/catalogue/planned_products/">

              <img src="./小農首頁3_files/handdraw-btn.png">

              <span class="handdraw-btn-long">看看全部計畫性支持專區&nbsp;&nbsp;&gt;</span>
        ...
        <section class="block">
          ...
          <div class="row">
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/how-to-pick-a-good-egg_4118/" id="how-to-pick-a-good-egg_4118">
                <div class="pic">
                  <img src="./小農首頁3_files/pic-btn(2).jpg">
                  <div class="sub-title tag-color2">識食</div>
                </div>

                <h5><span>蛋液稀、蛋難剝，跟新鮮有關嗎？達人帶你挑好蛋吃好蛋</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/roe-cooking_3313/" id="roe-cooking_3313">
                <div class="pic">
                  <img src="./小農首頁3_files/未命名-1.jpg">
                  <div class="sub-title tag-color1">食譜</div>
                </div>

                <h5><span>你知道烏魚子去膜更鮮美嗎?30秒去膜秘訣&amp;5分鐘出前菜!</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/recipe-dried-ornage-peel_1476/" id="recipe-dried-ornage-peel_1476">
                <div class="pic">
                  <img src="./小農首頁3_files/AR-028-btn.jpg">
                  <div class="sub-title tag-color1">食譜</div>
                </div>

                <h5><span>食譜-原來自製陳皮這麼簡單！</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/abiu-taste-preserve_3461/" id="abiu-taste-preserve_3461">
                <div class="pic">
                  <img src="./小農首頁3_files/cover1_13.jpg">
                  <div class="sub-title tag-color2">識食</div>
                </div>

                <h5><span>帶你嚐鮮超吸睛金黃色果實！黃金果的品嚐方法與保存技巧</span></h5>
                <p style="overflow-wrap: break-word;">你吃過黃金果嗎？金黃色的圓滾外表喜慶又討喜，是...</p>
              </a></div>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/Goat-Meat-Domestic-Cooking_3344/" id="Goat-Meat-Domestic-Cooking_3344">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-270x270-72羊肉.jpg">
                  <div class="sub-title tag-color2">識食</div>
                </div>

                <h5><span>不羶又Q彈，認識顛覆味蕾的高質本土羊肉&amp;挑選建議</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/TW-strawberry-variety_2707/" id="TW-strawberry-variety_2707">
                <div class="pic">
                  <img src="./小農首頁3_files/btn-TW-strawberry-variety.jpg">
                  <div class="sub-title tag-color2">識食</div>
                </div>

                <h5><span>這些本土草莓你認識幾種？</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/dried-mushroom_3355/" id="dried-mushroom_3355">
                <div class="pic">
                  <img src="./小農首頁3_files/btn.jpg">
                  <div class="sub-title tag-color2">識食</div>
                </div>

                <h5><span>鮮香菇VS乾香菇，香氣、營養差別在哪？</span></h5>
            ...
            <div class="box">
              <a href="https://www.buydirectlyfromfarmers.tw/catalogue/peanut-aflatoxin_3444/" id="peanut-aflatoxin_3444">
                <div class="pic">
                  <img src="./小農首頁3_files/btn(1).jpg">
                  <div class="sub-title tag-color2">識食</div>
                </div>

                <h5><span>向黃麴毒素SAY NO，花生這樣選</span></h5>
          ...
          <div class="btn btn-hover handdraw-btn" style="position: relative; width: 261px; height: 43px;">
            ...
            <a href="https://www.buydirectlyfromfarmers.tw/catalogue/category/bian-chi-bian-du_40/">

              <img src="./小農首頁3_files/handdraw-btn.png">

              <span class="handdraw-btn-short">看看全部邊吃邊讀&nbsp;&nbsp;&gt;</span>
  ...
  </div><script type="text/javascript" id="">(function(a,e,b,f,g,c,d){a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};c=e.createElement(f);c.async=1;c.src="https://www.clarity.ms/tag/"+g+"?ref\x3dgtm2";d=e.getElementsByTagName(f)[0];d.parentNode.insertBefore(c,d)})(window,document,"clarity","script","8frlty15ix");</script> <!-- container -->
  <!-- content -->
...
<%--       <jsp:include page="/front-end/home/footer.jsp" flush="true"/> --%>
 <iframe src="<%= request.getContextPath() %>/front-end/home/footer.jsp" width="100%" height="100%" style="display: block;"></iframe>
  ...
  <script src="./小農首頁3_files/bdff_bremen.js" type="text/javascript" charset="utf-8"></script>
