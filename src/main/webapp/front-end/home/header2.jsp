...
<html lang="zh-tw" class="no-js fontawesome-i2svg-active fontawesome-i2svg-complete arwf-inactive"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <script async="" src="<%=request.getContextPath()%>/mem_yu/header/header_files/8frlty15ix"></script><script async="" src="<%=request.getContextPath()%>/mem_yu/header/header_files/clarity.js"></script><script async="" src="<%=request.getContextPath()%>/mem_yu/header/header_files/8frlty15ix"></script><script async="" src="<%=request.getContextPath()%>/mem_yu/header/header_files/gtm.js"></script><script async="" src="<%=request.getContextPath()%>/mem_yu/header/header_files/analytics.js"></script><script defer="" src="<%=request.getContextPath()%>/mem_yu/header/header_files/all.js"></script>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/mem_yu/header/header_files/header2.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/mem_yu/header/header_files/style2.css">
 ...
 <%--  <link rel="stylesheet" href="<%=request.getContextPath()%>/mem_yu/header/header_files/index.css"> --%>

  <script type="text/javascript" src="<%=request.getContextPath()%>/mem_yu/header/header_files/1473064767308.JS"></script>
...
<section class="header-wrapper" style="position: static;">
    ...
    <header id="header">
      ...
      <div class="logo"><a href="https://www.buydirectlyfromfarmers.tw/"><img src="<%=request.getContextPath()%>/mem_yu/header/header_files/透明LOGO有字有框.png"></a></div>
    ...
    <!-- header -->
      ...
      <!-- jQuery -->
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/jquery.js"></script>
      <script>
      ...
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/bdff_bremen.js" type="text/javascript" charset="utf-8"></script>
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/jquery-2.2.1.min.js"></script>
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/plugins.js"></script>
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/menu.js"></script>
    
      <!-- bdff -->
    
    
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/index.js"></script>
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/jquery.dotdotdot.js"></script>
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/dotdotdot-desc.js"></script>
      <script>
      ...
      <!-- bdff -->
      <script src="<%=request.getContextPath()%>/mem_yu/header/header_files/jquery.cookie.js"></script>
      <script>
        var django = (function ($) {
          var _urls = {}
          var _conf = {}
