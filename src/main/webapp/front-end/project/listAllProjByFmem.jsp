									...
									<div class="projectCard">
										...
										<div class="projectThumb" style="position: relative;">
											...
											<div style="position: absolute; right: 0; top: 0;">
												<a
													href="${pageContext.request.contextPath}/project/project.do?proj_id=${projectVO.proj_id}&f_mem_id=${projectVO.f_mem_id}&action=getOne_For_Display_ByFmem">
													<img
													src="<%= request.getContextPath() %>/front-end/project/projectoverview_files/Edit_icon.png"
													class="projectCoverImg img-responsive"
													style="left: 70%; transition: opacity 350ms; width: 30%; height: 30%; z-index: 999; position: relative;">
												</a>
											</div>
							...
							<div class="col-md-4 col-sm-6">
								<div class="projectCard">
									...
									<div class="downMeta">
										...
										<label class="tag red"
											style="text-align: center; top: 50%; display: block; position: relative;">
											<strong>新增專案</strong>
										</label>
									</div>
								</div>
