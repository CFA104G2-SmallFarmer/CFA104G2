	...
	<div class="container mv4-l mt3-l">
		<div class="gutter3-l flex">
            ...
            <div class="w-30-l w-100 ph3">
                ...
                <a class="db"
                   href="#"><h2
                        class="f4 mt2 mb1">${projectVO.proj_name}</h2></a>
                <a class="b f6"
				...
				<div class="mb1 f7"style="font-size:16px" id="dayleft">
					<!-- 算完取條件判斷後呈現 -->
					<span class="mr2 b"> <c:set var="prefix" value="剩餘時間" />
                        <c:set var="suffix" value="天" />
                        <c:choose>
                        ...
                        <table class="w-100"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>
                                        如需售後服務／退換貨服務，請私信：${fmemSvc.getOneFMem(projectSvc.getOneProject(projectVO.proj_id).f_mem_id).f_mem_fname}。</p>
                                    <div class="nt6">
                ...
                <c:forEach var="projPerkVO" items="${list}" begin="<%=0%>"
                    ...
                    <div style="margin-bottom: 20px;"
                        ...
                        <div
                            ...
                            <div style="font-size: 14px" class="mt3 gray tc ph2 f7 ba">
                                預計於${projPerkVO.perk_ship_date}實現
                            </div>
