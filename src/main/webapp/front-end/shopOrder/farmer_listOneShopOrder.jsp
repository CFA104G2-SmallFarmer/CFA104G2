...
<link href="./farmer_order_css/index.f923077f35fa95f6d6ec.css"
	data-module="vendor" rel="stylesheet">
<link href="./farmer_order_css/index.2b1612d1a8fda6896c22.css"
...
<link data-module="order" rel="stylesheet" type="text/css"
	href="./farmer_order_css/331.155057b0fc3b98ce38f8.css">
<link data-module="order" rel="stylesheet" type="text/css"
...
<body class=" route-index route-portal-sale route-portal-sale-order route-portal-sale-order">
            ...
            <div data-v-550e8c91="" class="fulfillment-order-page-content">
              <div data-v-acb72a84="" data-v-550e8c91="" class="order-list">
                <div data-v-acb72a84="" class="padding-wrap">
                        ...
                        <span class="shopee-input-group__append">
				...
				style="font-size: 30px; color: red">查詢結果</div>
                <br>
                <div class="ccle">
                 <a href="./farmer_searchShopOrderPage.jsp">
                        <input type="button" value="回訂單管理頁面" class="gree"> 
                    </a>
                </div>
                <br>
                <!---->
                <!-- 訂單瀏覽列start -->
     <div data-v-a414b804="" class="order-list-pannel">
                  <div class="order-list-section">
                    <div>
                      <div data-v-dff31658="" class="fixed-container" style="top: 112px; z-index: 999;">
                        <div data-v-a414b804="" class="order-list-header">
                          <span data-v-a414b804="" class="item-product" min-width:80px;="">
                            會員資料</span>
			...
			<div data-v-1eaa89e5="" data-v-a414b804="" class="order-list-body">
				<a data-v-1eaa89e5="" target="_blank" class="order-item"> 
				<!-- 這邊是開始 -->
					<div data-v-1eaa89e5="" class="order-title">
						<div data-v-1eaa89e5="" class="title-prefix">
							<div data-v-78a21620="" data-v-1eaa89e5=""
								class="user-header user-view-item simple-nofollow">
								...
								<i class="material-icons"
									style="color: #aaba8b; display: inline;">sms</i>
							</div>
						</div>
						<div data-v-1eaa89e5="" class="id-btn">
							<span data-v-1eaa89e5="" class="orderid"
								style="color: red; font-size: 20px;"> 訂單狀態 : &nbsp; <%
 ...
 <%--${order_state_arr[x ]}這個方式會失敗，上面的會成功  --%>
					...
					</div> <%-- 錯誤表列start --%> <c:if test="${not empty errorMsgs}">
					...
					<div data-v-1274329c="" data-v-1eaa89e5=""
						class="order-item-root-wrap">
								...
								<div data-v-1274329c="" class="body">
														...
														<div data-v-3eef092e="" class="ct-item-product-inner">
															<div data-v-3eef092e="" class="ct-item-product-info">
																<div style="color: #717d34; font-size: 16px;">
																	<div
																		onclick="location.href='https://www.google.com.tw';"
																		style="cursor: pointer; color: #717d34; font-size: 16px;">
																		訂單編號&nbsp; :
																		<%=shopOrderVO.getOrder_id()%></div>
																</div>
																<span> 收貨地址：<%=shopOrderVO.getOrder_add()%>
																</span> <span>收件人：陳小明</span> <span>收件人電話:0923123412</span>
															</div>
														</div>
													</div>
												</div>
									...
									<div data-v-1274329c="" class="item-channel">
										<div data-v-1274329c="" class="carrier-name"
											style="font-size: 16px; padding-top: 4px;">
											<span> 訂單時間： <br> ${shoporderVO.order_date}
											</span> <br> <span> 出貨時間： <br>  ${shoporderVO.order_ship_date}
											</span> <br> <span> 完成時間： <br>  ${shoporderVO.order_finish_date}
											</span>

										</div>
										<div data-v-1274329c="" class="tracking-number-wrapper">
											<div data-v-1274329c="" class="lable"></div>
										</div>
									</div>
									<!-- 功能按鈕 -->
...
<!-- 									為了更改狀態而新增 -->
    							...
    							<input type="hidden" name="mem_id"  value="<%=shopOrderVO.getMem_id()%>">	
    							<input type="hidden" name="order_date"  value="<%=shopOrderVO.getOrder_date()%>">	
    							<input type="hidden" name="order_ship_date"  value="<%=shopOrderVO.getF_mem_id()%>">	
    							<input type="hidden" name="order_add"  value="<%=shopOrderVO.getOrder_add()%>">	
    							<input type="hidden" name="order_amount"  value="<%=shopOrderVO.getOrder_amount()%>">	
    							<input type="hidden" name="order_memo"  value="<%=shopOrderVO.getOrder_memo()%>">	
    							<input type="hidden" name="order_ship_date"  value="<%=shopOrderVO.getOrder_ship_date()%>">	
    							<input type="hidden" name="order_payment"  value="<%=shopOrderVO.getOrder_payment()%>">		 			  
