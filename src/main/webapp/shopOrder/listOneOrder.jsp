...
<%--                               <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/shopjOrder/shopjOrder.do">		 			   --%>
...
<!-- 			  				   </FORM> -->
                              ...
                              <c:choose>
    							...
    							<input type="hidden" name="order_zipcode"  value="<%=shopOrderVO.getMem_id()%>">	
    							<input type="hidden" name="order_zipcode"  value="<%=shopOrderVO.getF_mem_id()%>">	
    							<input type="hidden" name="order_addr"  value="<%=shopOrderVO.getOrder_add()%>">	
    							<input type="hidden" name="order_receiver"  value="<%=shopOrderVO.getOrder_receiver()%>">	
    							<input type="hidden" name="order_tel"  value="<%=shopOrderVO.getOrder_tel()%>">	
...
<%--     							<input type="hidden" name="order_memo"  value="<%=shopOrderVO.getOrder_payment()%>"> --%>
    							<input type="hidden" name="order_state"  value="<%=shopOrderVO.getOrder_state()%>">	
    							<input type="hidden" name="order_order_date"  value="<%=shopOrderVO.getOrder_date()%>">	
<%--     							<input type="hidden" name="order_ship_date"  value="<%=shopOrderVO.getOrder_ship_date()%>">	 --%>
    							<input type="hidden" name="order_finish_date"  value="<%=shopOrderVO.getOrder_finish_date()%>">	
    							<input type="hidden" name="order_cancel_date"  value="<%=shopOrderVO.getOrder_cancel_date()%>">		 			  
			     				...
			     				<input type="hidden" name="action" value="update_state_to_3">	 			  
                                  ...
                                  <button data-v-4325ccd1="" 
                                    class="shopee-button shopee-button--normal" type="submit"><span>
   							  	...
   							  	<c:when test="${shopOrderVO.order_state ==4}">
    							 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/shopOrder/shopOrder.do">	
    							<input type="hidden" name="order_id"  value="<%=shopOrderVO.getOrder_id()%>">	
    							<input type="hidden" name="order_zipcode"  value="<%=shopOrderVO.getMem_id()%>">	
    							<input type="hidden" name="order_zipcode"  value="<%=shopOrderVO.getF_mem_id()%>">	
