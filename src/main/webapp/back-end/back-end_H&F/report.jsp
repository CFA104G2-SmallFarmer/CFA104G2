...
<%
    ...
    if (adminLoginVO.getAdmin_type_id()==2 || adminLoginVO.getAdmin_type_id()==4) {                                             
    	try {                                                        
  ...
  <header class="header">
    ...
    <div class="main_container">
      ...
      <main class="main">
        ...
        <h1 class="title2">檢舉審核列表</h1><hr>
        
        <div class="item_block">
          <button type="submit" class="btn_submit3">商城檢舉</button>
        </div>
      <hr>
      ...
      <hr>
         ...
         <div class="item_block">
          <button type="submit" class="btn_submit3">農遊檢舉</button>
        </div>
      ...
      <div class="item_block">
          <button type="submit" class="btn_submit3">認養檢舉</button>
        </div>
