    ...
    <div class="shopee-tabs__nav">
      <div class="shopee-tabs__nav-warp">
        <div class="shopee-tabs__nav-tabs" style="transform: translateX(300px);">
          ...
          <div class="shopee-tabs__nav-tab" style="white-space: normal;">
            <div data-v-ddf12cca="" class="tab-label"><a href="listAllProduct.jsp">我的商品</a>
          </div>
          </div>
        </div>
      </div>
            ...
            <div class="w-70-l w-150 ph3">
              ...
              <div class="">  
                <label class="b " for="user_email">小農會員編號:</label>
                  <input required="required" class="w-20 mb3" type="text" value="<%= (shopProductVO==null)? "70000" : shopProductVO.getF_mem_id()%>" name="f_mem_id" />
                <label class="b" for="user_name">商品名稱:</label>
                <input required="required" class="w-30 mb3" type="text" value="<%= (shopProductVO==null)? "草莓好吃" : shopProductVO.getProd_name()%>"  name="prod_name" />
           ...
           <label class="b">商品類別:</label>
			...
			<c:forEach var="shopProductTypeVO" items="${productTypeSvc.all}">
              ...
              <label class="mt3 b" for="order_note">商品介紹:<span class="gray mb3">特色說明</span></label>
                  <textarea  class="w-100 height-100" type="text" value="<%= (shopProductVO==null)? "填寫介紹" : shopProductVO.getProd_intro()%>"  name="prod_intro" />
                  </textarea>
